    ...
    >
      ...
      <div className="w-full max-w-sm relative z-0">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-wc-navy-400 text-xs mt-2 tracking-[0.15em] uppercase font-semibold">Pool Picks</p>
        </div>

        {/* Card */}
        <div className="bg-wc-navy-900/90 backdrop-blur-sm border border-wc-navy-700/80 rounded-2xl p-7 shadow-2xl shadow-black/60">
          {/* Top accent */}
          <div className="absolute inset-x-0 top-0 h-[2px] bg-gradient-to-r from-wc-blue-600 to-wc-blue-400 rounded-t-2xl" style={{ borderRadius: '16px 16px 0 0' }} />
          ...
          <p className="text-center text-wc-navy-500 text-sm mt-6">
            No account?{' '}
            <Link href="/register" className="text-wc-blue-400 hover:text-wc-blue-300 font-bold transition-colors">
              Register
            </Link>
          </p>
        </div>
